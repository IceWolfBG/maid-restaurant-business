...
public class TaskSafetyConfig {
    ...
    public static final ForgeConfigSpec.IntValue TASK_TIMEOUT_PACKAGING;
    public static final ForgeConfigSpec.IntValue TASK_TIMEOUT_DELIVERY;
    public static final ForgeConfigSpec.IntValue TASK_TIMEOUT_COOKING;
    public static final ForgeConfigSpec.IntValue TASK_TIMEOUT_PREP;
    public static final ForgeConfigSpec.IntValue TASK_TIMEOUT_DISHWASHING;
    public static final ForgeConfigSpec.IntValue TASK_TIMEOUT_COLLECT_PLATE;

    // ========== ASSIGNED任务超时 ==========
    public static final ForgeConfigSpec.IntValue ASSIGNED_TASK_TIMEOUT;

    // ========== PENDING任务超时 ==========
    public static final ForgeConfigSpec.IntValue PENDING_TASK_TIMEOUT;

    // ========== 厨具占用超时 ==========
    public static final ForgeConfigSpec.IntValue DEVICE_OCCUPY_TIMEOUT;
    ...
    // ========== 激进卡住检测 ==========
    public static final ForgeConfigSpec.DoubleValue STUCK_DETECTION_MULTIPLIER;
