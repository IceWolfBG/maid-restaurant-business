...
public class TakeoutConfig {
    ...
    // 配送速度相关
    public static final ForgeConfigSpec.IntValue BASE_DELIVERY_SPEED;
    public static final ForgeConfigSpec.IntValue SPEED_PER_LEVEL;
    public static final ForgeConfigSpec.IntValue MIN_DELIVERY_SECONDS;
    public static final ForgeConfigSpec.IntValue MAX_DELIVERY_SECONDS;

    // 手续费相关
    public static final ForgeConfigSpec.DoubleValue BASE_FEE;
