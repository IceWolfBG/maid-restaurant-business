...
public class BatchCookingConfig {
    ...
    public static final ForgeConfigSpec.IntValue STEAMER_CAP;
    public static final ForgeConfigSpec.IntValue OVEN_CAP;
    public static final ForgeConfigSpec.IntValue TOASTER_CAP;
    public static final ForgeConfigSpec.IntValue BLENDER_CAP;

    // 缓存值（onLoad 时从 SPEC 同步，运行期直接读静态字段，避免每 tick 查配置对象）
